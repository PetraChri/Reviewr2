...
var app = {
    ...
    firstLoad: function(){
        ...
        var cameraBtn = document.getElementById("pic");
        var revBtn = document.getElementById("reviews");
        ...
        if (parseInt(xhr.status) < 300) {
            ...
            if (data.code == 0) { // Zero from PHP = OK
                ...
                if (reviews.length > 0) { // we have previous review(s)
                    ...
                    console.log("Existing reviews: " + data.message);
                    ...
                    reviews.forEach(function (obj) { // forEach accaepts an iterator function and optionally, a value to use as this 
                        ...
                        console.log("Existing data:" + obj.id + " Title: " + obj.title + " Rating: " + obj.rating);
                    });
